...
fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTime != it.startTimeMili) {
                ...
                // Hours
                append("\t ${it.endTime.minus(it.startTimeMili) / 1000 / 60 / 60}:")
                // Minutes
                append("${it.endTime.minus(it.startTimeMili) / 1000 / 60}:")
                // Seconds
                append("${it.endTime.minus(it.startTimeMili) / 1000}<br><br>")
            }
        }
    }
